...
public class CustomUserTest {
	...
	public void loadUsernameTest() {
		...
		when(service.loadUserByUsername("111"))
		.thenReturn(new org.springframework.security.core.userdetails.User(String.valueOf(user.getUserId()),user.getPassword(),roles));
